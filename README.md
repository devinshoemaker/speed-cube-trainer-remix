...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create speed-cube-trainer-remix-d03d
  fly apps create speed-cube-trainer-remix-d03d-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app speed-cube-trainer-remix-d03d
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app speed-cube-trainer-remix-d03d-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'speed-cube-trainer-remix-d03d-staging' does not match app name in config file 'speed-cube-trainer-remix-d03d'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name speed-cube-trainer-remix-d03d-db
  fly postgres attach --app speed-cube-trainer-remix-d03d speed-cube-trainer-remix-d03d-db

  fly postgres create --name speed-cube-trainer-remix-d03d-staging-db
  fly postgres attach --app speed-cube-trainer-remix-d03d-staging speed-cube-trainer-remix-d03d-staging-db
  ```
